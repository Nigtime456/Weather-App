...
class CitiesMarshallingHelper {
    ...
    fun readFromReader(reader: Reader): Flowable<ReferenceCitiesTable> {
    ...
    private fun makeCity(jsonReader: JsonReader): ReferenceCitiesTable {
        var id = 0L
        var name = ""
        var stateName = ""
        var countryName = ""
