...
import com.gmail.nigtime456.weatherapplication.screen.current.forecast.list.DailyWeatherAdapter
import com.gmail.nigtime456.weatherapplication.screen.current.forecast.list.HourlyWeatherAdapter
...
class CurrentForecastFragment :
    ...
    override fun getPresenterFactory(): BasePresenterProvider<CurrentForecastPresenter> {
