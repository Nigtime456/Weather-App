...
import com.gmail.nigtime456.weatherapplication.screen.daily.forecast.DailyForecastFragment

class DailyHostPageAdapter(host: Fragment, private val location: SavedLocation) :
